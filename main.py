...
def main():
    ...
    1. A short summary about the person in 1 sentences.
    ...
    # 3. USE .invoke() WITH A DICTIONARY
    response = chain.invoke({"information": information})

    # 4. ACCESS THE CONTENT FROM THE RESPONSE OBJECT
